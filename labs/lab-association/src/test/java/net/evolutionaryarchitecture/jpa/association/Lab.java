...
public class Lab {
    ...
    /*
     * 
     * TODO: BONUS Uncomment test below to experiment with detached entities
     * 
     * Hint for this to work you probably will need to amend the
     * EventRepository. Consider doing something like:
     * 
     ...
     * "where event.id=:eventId"); query.setLong("eventId", eventId); Event
