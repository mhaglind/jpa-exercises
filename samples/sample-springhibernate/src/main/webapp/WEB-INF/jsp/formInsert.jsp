...
<body>
  <div id="main">
    ...
    <div id="content">
	   ...
	   <h1>Create Public Course: <c:out value="${command.title}"/> </h1>
       <br/>
       <form:form>
           ...
           <div>
			   <form:label path="classRoom">Classroom:</form:label>
               <form:textarea path="classRoom" rows="3" cols="20" />
               <form:errors path="classRoom" cssClass="error" />
           </div>
           
           <div>
			   <form:label path="instructor">Instructor:</form:label>
               <form:textarea path="instructor" rows="3" cols="20" />
